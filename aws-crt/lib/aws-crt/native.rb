...
module Aws
  module Crt
    ...
    module Native
      ...
      attach_function :global_thread_creator_shutdown_wait_for, :aws_global_thread_creator_shutdown_wait_for, [:uint32], :void
      # IO API
      ...
      attach_function :test_error, :aws_crt_test_error, [], :int
